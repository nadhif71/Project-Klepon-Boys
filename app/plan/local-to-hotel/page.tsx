  ...
  return (
    <div className="space-y-10 font-avenir">
      <ScrollReveal direction="none">
        <div>
          <h2 className="text-3xl font-bold text-main-darkbrown uppercase tracking-tighter">Kembali Ke Penginapan</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              <button
                ...
                className={`flex items-center justify-between rounded-xl px-6 py-5 transition-all duration-300 relative ${
                  type === t.id
                    ? 'bg-main-gold/10 text-main-darkbrown scale-[1.01] shadow-lg shadow-main-gold/5'
            ...
            <div className="rounded-2xl bg-white p-8 space-y-8 shadow-2xl shadow-main-darkbrown/5 animate-in zoom-in-95 duration-500">
                ...
                <div className="space-y-8">
                  <div className="flex gap-4 overflow-x-auto pb-2 no-scrollbar">
                     {[
                       ...
                       <div key={mode.name} className="shrink-0 flex items-center gap-2 bg-main-gray/10 px-3 py-1.5 rounded-lg">
                  ...
                  <p className="text-[11px] font-bold text-main-darkbrown uppercase tracking-widest leading-relaxed">
                    Rute menuju <span className="underline underline-offset-4">{currentPlan?.hotel?.name || 'Penginapan'}</span> telah dioptimalkan.
                  </p>
                  
                  <div className="aspect-video bg-main-cream/30 rounded-xl flex items-center justify-center relative overflow-hidden group cursor-pointer shadow-inner">
                     <div className="absolute inset-0 bg-[url('https://maps.googleapis.com/maps/api/staticmap?center=-6.2146,106.8451&zoom=13&size=600x300&markers=color:red%7C-6.2146,106.8451&markers=color:blue%7C-6.2200,106.8500&markers=color:green%7C-6.2100,106.8400&key=YOUR_API_KEY')] bg-cover opacity-40 transition-all duration-500"></div>
                     <div className="relative z-10 text-[10px] font-bold uppercase tracking-[0.3em] text-main-darkbrown bg-white/90 backdrop-blur-md px-8 py-4 rounded-full shadow-2xl transition-all">
                       Buka Navigasi Rute
                     </div>
                  </div>
                </div>
              ...
              {isGojek && (
                <div className="space-y-6">
                  ...
                  <div className="bg-[#00AA13]/5 rounded-xl border border-[#00AA13]/20 p-8 space-y-6">
                     <div className="flex items-center gap-6">
                        <div className="h-14 w-14 rounded-xl bg-[#00AA13] flex items-center justify-center text-white text-2xl shadow-xl shadow-[#00AA13]/20"></div>
                        <div>
                     ...
                     <button type="button" className="w-full bg-[#00AA13] text-white py-5 rounded-xl font-bold text-[10px] uppercase tracking-widest transition-all">
                       Buka Aplikasi Gojek
                     </button>
                  </div>
                </div>
        ...
        <ScrollReveal delay={300}>
          <div className="space-y-6 pt-6">
            <div className="flex gap-4">
              ...
              <Button
                type="button"
                className="flex-[2] rounded-xl h-16 text-[10px] font-bold uppercase tracking-widest"
                disabled={!type}
