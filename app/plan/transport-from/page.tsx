      ...
      <form onSubmit={handleFinish} className="space-y-8">
        <div className="grid grid-cols-1 gap-6">
          ...
          <div className="space-y-3 relative" ref={originRef}>
            ...
            <div onClick={() => setIsOriginOpen(!isOriginOpen)} className="w-full rounded-2xl border-2 border-main-gray bg-transparent px-5 py-4 flex items-center justify-between cursor-pointer hover:border-main-gold/50 transition-colors">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-3 relative" ref={cityRef}>
              ...
              <div onClick={() => originHub && setIsCityOpen(!isCityOpen)} className={`w-full rounded-2xl border-2 border-main-gray bg-transparent px-5 py-4 flex items-center justify-between cursor-pointer transition-colors ${!originHub ? 'opacity-50 cursor-not-allowed' : 'hover:border-main-gold/50'}`}>
            ...
            <div className="space-y-3 relative" ref={hubRef}>
              ...
              <div onClick={() => destCity && setIsHubOpen(!isHubOpen)} className={`w-full rounded-2xl border-2 border-main-gray bg-transparent px-5 py-4 flex items-center justify-between cursor-pointer transition-colors ${!destCity ? 'opacity-50 cursor-not-allowed' : 'hover:border-main-gold/50'}`}>
        ...
        <div className="flex gap-4 pt-6">
          ...
          <Button type="submit" disabled={!selectedOption} className="flex-[2] rounded-2xl h-16 text-[10px] font-bold uppercase tracking-widest shadow-xl shadow-main-darkbrown/10">Finish Plan</Button>
        </div>
      </form>
    </div>
  );
