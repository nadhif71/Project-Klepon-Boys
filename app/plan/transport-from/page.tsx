      ...
      <form onSubmit={handleFinish} className="space-y-8">
        <ScrollReveal delay={100}>
          <div className="space-y-10">
            ...
            <div className={`grid grid-cols-1 gap-6 relative ${isCityOpen || isHubOpen || isOriginOpen ? 'z-50' : 'z-10'}`}>
              <div className={`space-y-3 relative ${isOriginOpen ? 'z-30' : 'z-20'}`} ref={originRef}>
                <label className="block text-[8px] font-bold uppercase tracking-[0.2em] text-main-darkbrown/40 ml-1">Titik Jemput (Jakarta)</label>
                <div onClick={() => setIsOriginOpen(!isOriginOpen)} className="w-full rounded-xl border-2 border-main-gray bg-white px-5 py-4 flex items-center justify-between cursor-pointer hover:border-main-gold/50 transition-colors">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className={`space-y-3 relative ${isCityOpen ? 'z-30' : 'z-10'}`} ref={cityRef}>
                  <label className="block text-[8px] font-bold uppercase tracking-[0.2em] text-main-darkbrown/40 ml-1">Kota Tujuan</label>
                  <div onClick={() => originHub && setIsCityOpen(!isCityOpen)} className={`w-full rounded-xl border-2 border-main-gray bg-white px-5 py-4 flex items-center justify-between cursor-pointer transition-colors ${!originHub ? 'opacity-50 cursor-not-allowed' : 'hover:border-main-gold/50'}`}>
                ...
                <div className={`space-y-3 relative ${isHubOpen ? 'z-30' : 'z-0'}`} ref={hubRef}>
                  <label className="block text-[8px] font-bold uppercase tracking-[0.2em] text-main-darkbrown/40 ml-1">Titik Turun</label>
                  <div onClick={() => destCity && setIsHubOpen(!isHubOpen)} className={`w-full rounded-xl border-2 border-main-gray bg-white px-5 py-4 flex items-center justify-between cursor-pointer transition-colors ${!destCity ? 'opacity-50 cursor-not-allowed' : 'hover:border-main-gold/50'}`}>
