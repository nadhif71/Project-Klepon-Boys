...
export default function LocalToVenuePage() {
  ...
  return (
    <div className="space-y-10">
      <div>
        <h2 className="text-3xl font-black text-main-darkbrown italic uppercase tracking-tighter">Menuju Venue</h2>
            ...
            {isPublicTransport && (
              <div className="space-y-8">
                ...
                <p className="text-[11px] font-bold text-main-darkbrown uppercase tracking-widest leading-relaxed">
                  Rute gabungan menuju <span className="italic underline underline-offset-4">{currentPlan?.location || 'Venue'}</span> telah dioptimalkan.
                </p>
