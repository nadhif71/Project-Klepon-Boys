...
export default function LocalToVenuePage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-bold text-main-darkbrown">Ke Venue Konser (Opsional)</h2>
        <p className="mt-2 text-main-darkbrown/60">Bagaimana Anda akan pergi ke lokasi konser?</p>
      </div>
