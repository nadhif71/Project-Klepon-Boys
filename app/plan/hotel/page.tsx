      ...
      <form onSubmit={handleNext} className="space-y-10">
        <ScrollReveal delay={100}>
          <div className="space-y-8">
            <div className="flex items-center justify-between border-b border-main-gray pb-4 mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <input
                type="date"
                required
                className="w-full rounded-xl border-2 border-main-gray bg-transparent px-5 py-3 text-main-darkbrown font-bold focus:border-main-gold focus:outline-none transition-colors placeholder:text-main-darkbrown/10 uppercase tracking-widest text-xs"
                value={checkIn}
        ...
        <ScrollReveal delay={300}>
          <div className="flex gap-4 pt-6">
            ...
            <Button 
              ...
              className="flex-[2] rounded-xl h-16 text-[10px] font-bold uppercase tracking-widest shadow-xl shadow-main-darkbrown/10"
            >
              Next Step
            </Button>
          </div>
